export const PROJECTS = {
    npilookup: {
        ...
        technologies: 'C#, ASP.NET Core MVC, SQL (Amazon Redshift), Npgsql, JS, Ajax, jQuery, HTML, CSS, AWS',
    ...
    studytracker: {
        ...
        technologies: 'C#, ASP.NET Core, PostgreSQL, EF Core, Identity, Authentication and Authorization, ReactJS, HTML, CSS, TailwindCSS, AWS',
        link: 'This project has been sold and is private.',
    },
}